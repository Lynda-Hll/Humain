  ...
  return (
    <div className="Aceuil">
      ...
      <div className="bodyDon">
        ...
        {openAutre && (
          <ModalAutre show={openAutre} autreFuncClose={autreFuncClose} />
        )}
        ...
        <div className="bodyDonAction">
          <div>
            {" "}
            <button className="fab" variant="extended" onClick={donFunc}>
              <PaidIcon sx={{ mr: 1 }} />
          ...
          <div>
            {" "}
            <button variant="extended" className="fab" onClick={autreFunc}>
          ...
          <div>
            {" "}
            <button variant="extended" className="fab" onClick={motFunc}>
