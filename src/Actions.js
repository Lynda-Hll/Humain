...
function Actions({}) {
  ...
  return (
    <div className="Aceuil">
      ...
      <div className="body1">
        {openpaper0 && (
          <ModalPaper0 show={openpaper0} close={paper0FuncClose} />
        )}
        {openpaper2 && (
          <ModalPaper2 show={openpaper2} close={paper2FuncClose} />
        )}
        {openpaper3 && (
          <ModalPaper3 show={openpaper3} close={paper3FuncClose} />
        )}
        {openpaper4 && (
          <ModalPaper4 show={openpaper4} close={paper4FuncClose} />
        )}
        {openpaper5 && (
          <ModalPaper5 show={openpaper5} close={paper5FuncClose} />
        )}
        {openpaper1 && (
          <ModalPaper1 show={openpaper1} close={paper1FuncClose} />
        )}
            ...
            <div className="paper0" onClick={paper0Func}>
              <p
                style={{
                  color: "white",
                  fontSize: "2rem",
                  textDecoration: "underline overline #fff",
                }}
              >
                Aide alimentaire
              </p>
